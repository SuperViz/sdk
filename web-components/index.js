...
`;var _=n=>{var e;class t extends n{connectedCallback(){setTimeout(()=>{var i;let r=document.getElementById("superviz-style"),o=document.createElement("style");o.innerHTML=(r==null?void 0:r.innerHTML)||"",(i=this.shadowRoot)==null||i.appendChild(o)}),super.connectedCallback()}emitEvent(r,o,i={composed:!0,bubbles:!0}){let a=new CustomEvent(r,v({detail:o},i));this.dispatchEvent(a)}}return t.styles=[pn,fn,yn,gn,(e=n.styles)!=null?e:[]],t};var mi=_(E),ha=[mi.styles],Nt=class extends mi{constructor(){super();this.name="",this.size="md"}render(){return y` <i class="sv-icon sv-icon-${this.name}_${this.size}"></i> `}};Nt.properties={name:{type:String},size:{type:String}},Nt.styles=[ha,x`
      div {
        position: absolute;
        top: 0;
        left: 0;
