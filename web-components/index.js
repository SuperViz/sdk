...
`;var ee=class extends x{constructor(){super();this.updatePresenceMouseParticipant=e=>{if(!this.shadowRoot.getElementById(`mouse-${e.id}`)){let a=this.shadowRoot.getElementById("mouse-sync"),l=document.createElement("div");l.setAttribute("id",`mouse-${e.id}`),l.setAttribute("class","mouse-follower");let c=document.createElement("div");c.setAttribute("class","pointer-mouse");let u=document.createElement("div");u.setAttribute("class","mouse-user-name"),u.innerHTML=e.name,l.appendChild(c),l.appendChild(u),a&&a.appendChild(l)}let r=this.shadowRoot.getElementById(`mouse-${e.id}`);if(!r)return;let i=this.shadowRoot.getElementById(`mouse-${e.id}`),o=this.shadowRoot.getElementById(`mouse-${e.id}`);if(i&&o){let a=i.getElementsByClassName("mouse-user-name")[0],l=o.getElementsByClassName("pointer-mouse")[0];l&&(l.style.backgroundImage=`url(https://production.cdn.superviz.com/static/pointers/${e.slotIndex}.svg)`),a&&(a.style.color=this.textColorValues.includes(e.slotIndex)?"#FFFFFF":"#000000",a.style.backgroundColor=e.color,a.innerHTML=e.name);let{containerId:c}=e,u=document.getElementById(c),d=e.mousePositionX,g=e.mousePositionY;if(c){let p=(u==null?void 0:u.clientWidth)||1,E=(u==null?void 0:u.clientHeight)||1;d=e.mousePositionX/e.originalWidth*p,g=e.mousePositionY/e.originalHeight*E}r.style.left=`${d}px`,r.style.top=`${g}px`}};this.textColorValues=[2,4,5,7,8,16]}removePresenceMouseParticipant(e){let s=this.shadowRoot.getElementById(`mouse-${e}`);s&&s.remove()}render(){return f`
    ...
    `}};ee.styles=[po],ee=T([$("superviz-presence-mouse")],ee);var Ts=b`  
  .modal--overlay {
    position: absolute;
    top: 0;
    left: 0;
...
`;var fo=_(x),ia=[fo.styles,Ts],se=class extends fo{constructor(){super(...arguments);this.getContainer=()=>window.document.querySelector("superviz-modal-container");this.createContainer=e=>{this.modal=document.createElement("superviz-modal-container"),this.modal.setOptions(e)};this.createModal=({detail:e})=>{this.createContainer(e),window.document.body.appendChild(this.modal)};this.destroyModal=()=>{var e;this.modal=void 0,(e=this.getContainer())==null||e.remove()}}firstUpdated(){window.document.body.addEventListener("superviz-modal--open",this.createModal),window.document.body.addEventListener("superviz-modal--close",this.destroyModal)}disconnectedCallback(){this.destroyModal(),window.document.body.removeEventListener("superviz-modal--open",this.createModal),window.document.body.removeEventListener("superviz-modal--close",this.destroyModal)}};se.styles=ia,se=T([$("superviz-modal")],se);var yo=_(x),aa=[yo.styles,Ts],ne=class extends yo{constructor(){super(...arguments);this.closeModal=()=>{window.document.body.dispatchEvent(new CustomEvent("superviz-modal--close",{bubbles:!0,composed:!0}))};this.confirmModal=()=>{window.document.body.dispatchEvent(new CustomEvent("superviz-modal--confirm",{bubbles:!0,composed:!0}))}}setOptions(e){this.options=e}render(){let e=()=>f`
    ...
    `}};ne.styles=aa,ne=T([$("superviz-modal-container")],ne);var fn=b`
  .container {
    display: flex;
...
`;var An;function On(n){let t=n.querySelector("#superviz-comments");if(t&&!An){let e={childList:!0,attributes:!0,characterData:!0,subtree:!0};An=new MutationObserver(s=>{s.forEach(r=>{!r.removedNodes.length||r.removedNodes.forEach(i=>{i.id==="poweredby-footer"&&la(n)})})}),An.observe(t,e)}}function la(n){let t=document.createElement("div");t.id="poweredby-footer",t.className="footer";let e=document.createElement("div");e.className="powered-by powered-by--horizontal";let s=document.createElement("a");s.href="https://superviz.com/",s.target="_blank",s.className="link";let r=document.createElement("div");r.textContent="Powered by";let i=document.createElement("img");i.width=48,i.height=8.86,i.src="https://production.cdn.superviz.com/static/superviz-gray-logo.svg",e.appendChild(s),s.appendChild(r),r.appendChild(i),t.appendChild(e);let o=n.getElementById("superviz-comments");o&&o.appendChild(t),On(n)}var go=_(x),ca=[go.styles,fn,_n],Nt=class extends go{constructor(){super();this.annotations=[],this.annotationFilter="all",this.waterMarkState=!1}updateAnnotations(e){this.annotations=e}toggle(){this.emitEvent("toggle",{})}waterMarkStatus(e){this.waterMarkState=e}setFilter({detail:e}){let{filter:s}=e;this.annotationFilter=s}updated(e){super.updated(e),this.updateComplete.then(()=>{this.shadowRoot.querySelector("#superviz-comments")&&this.waterMarkState&&On(this.shadowRoot)})}render(){let e=[this.open?"container":"container-close"].join(" "),s=f` <div id="poweredby-footer" class="footer">
    ...
    `}};Nt.styles=ca,Nt.properties={open:{type:Boolean},annotations:{type:Object},annotationFilter:{type:String},waterMarkState:{type:Boolean}},Nt=T([$("superviz-comments")],Nt);var ua=_(x),da=[ua.styles,yn],re=class extends _(x){close(){this.dispatchEvent(new CustomEvent("close"))}render(){return f`
      <div class="topbar">
    ...
    `}};Zt.styles=Hl,Zt.properties={annotation:{type:Object},expandComments:{type:Boolean},selected:{type:String,reflect:!0},resolved:{type:Boolean},shouldShowUndoResolved:{type:Boolean,reflect:!0},isLastAnnotation:{type:Boolean},annotationFilter:{type:String}},Zt=T([$("superviz-comments-annotation-item")],Zt);var ki=_(x),Rl=[ki.styles],jt=class extends ki{constructor(){super(...arguments);this.emitEventOpenModal=()=>{window.document.body.dispatchEvent(new CustomEvent("superviz-modal--open",{detail:{title:"DELETE COMMENT",body:f`<span class="text text-big sv-gray-600">Are you sure you want to delete this comment? <br /> This action cannot be undone</span>`,confirmLabel:"DELETE",confirm:!0,cancel:!0},bubbles:!0,composed:!0}))};this.toggle=()=>{this.open=!this.open}}firstUpdated(){window.document.body.addEventListener("superviz-modal--close",()=>{!this.open||this.emitEvent("close",{},{bubbles:!1,composed:!1})}),window.document.body.addEventListener("superviz-modal--confirm",()=>{!this.open||(this.emitEvent("confirm",{},{bubbles:!1,composed:!1}),this.emitEventCloseModal())})}updated(e){e.has("open")&&(this.open&&setTimeout(()=>this.emitEventOpenModal()),this.open||setTimeout(()=>this.emitEventCloseModal()))}emitEventCloseModal(){!this.open||(window.document.body.dispatchEvent(new CustomEvent("superviz-modal--close",{detail:{open:!0},bubbles:!0,composed:!0})),this.emitEvent("close",{},{bubbles:!1,composed:!1}))}render(){let e=()=>{if(!!this.useSlot)return f`<slot name="modal-handler" @click=${this.toggle}></slot>`},s=()=>{if(!!this.open)return f`
        <superviz-modal></superviz-modal>
      `};return f`
      ${e()}
      ${s()}
    `}};jt.styles=Rl,jt.properties={open:{type:Boolean},useSlot:{type:Boolean}},jt=T([$("superviz-comments-delete-comments-modal")],jt);var Ii=_(x),Ul=[Ii.styles,Sn],Vl=10*1e3,qt=class extends Ii{constructor(){super();this.setTimer=()=>{clearTimeout(this.timeout),this.isCanceled=!1,this.timeout=setTimeout(()=>{this.isCanceled||(this.timeToHide=0,this.isCanceled=!1,this.hide())},this.timeToHide)};this.timeToHide=Vl,this.isCanceled=!1}firstUpdated(){this.setTimer()}hide(){this.emitEvent("hide",{},{bubbles:!1,composed:!1})}undone(){this.isCanceled=!0,this.hide(),this.emitEvent("undo-resolve",{type:"undo-resolve",resolved:!1},{bubbles:!1,composed:!1}),clearTimeout(this.timeout)}render(){return this.timeToHide===0?f``:this.isCanceled?f``:f`
    ...
    `}};qt.styles=Ul,qt.properties={timeToHide:{type:Number},isCanceled:{type:Boolean}},qt=T([$("superviz-comments-annotation-resolved")],qt);var Di=_(x),Pl=[Di.styles,Tn],as=[{label:"All comments",code:"all"},{label:"Resolved comments",code:"resolved"}],Gt=class extends Di{constructor(){super();this.caret="down"}render(){let e=this.filter==="all"?as[0].label:as[1].label,s=({detail:a})=>{this.emitEvent("select",{filter:a}),r()},r=()=>{this.caret=this.caret==="down"?"up":"down"},i=this.filter==="all"?as[0].code:as[1].code,o={text:!0,"text-bold":!0,"select-content":!0,"sv-gray-500":this.caret==="down","sv-gray-700":this.caret==="up"};return f`
      <div class="select">
    ...
    `}};Gt.styles=Pl,Gt.properties={filter:{type:String},caret:{type:String}},Gt=T([$("superviz-comments-annotation-filter")],Gt);var Ni=_(x),Wl=[Ni.styles,$n],Yt=class extends Ni{constructor(){super();this.isHidden=!0}toggle(){this.emitEvent("toggle",{})}connectedCallback(){super.connectedCallback(),window.document.body.addEventListener("toggle-annotation-sidebar",()=>{this.isHidden=!this.isHidden})}render(){let e={"float-button":!0,"hide-button":!this.isHidden};return f` <button @click=${this.toggle} class="${N(e)}">
      <superviz-icon name="comment"></superviz-icon>

      <p class="text text-big text-bold">Comments</p>
    </button>`}};Yt.styles=Wl,Yt.properties={isHidden:{type:Boolean}},Yt=T([$("superviz-comments-button")],Yt);export{Nt as Comments,Gt as CommentsAnnotationFilter,Zt as CommentsAnnotationItem,Bt as CommentsAnnotationPin,qt as CommentsAnnotationResolved,Lt as CommentsAnnotations,Wt as CommentsCommentInput,Pt as CommentsCommentItem,Ft as CommentsContent,Yt as CommentsFloatButton,re as CommentsTopbar,jt as DeleteCommentModal,Dt as Dropdown,kt as HelloWorld,It as Icon,se as Modal,ne as ModalContainer,ee as PresenceMouse};
/**
 * @license
